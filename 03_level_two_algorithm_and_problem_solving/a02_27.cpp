...
float AverageDigit(int arr[100], int arrLength, int sum){

    return (float)FindSumOfArray(arr, arrLength, sum) / arrLength;
}
...
int main(){
    ...
    cout << "\nAverage digit: " << AverageDigit(arr, arrLength, sum) << endl;
    return 0;
}
